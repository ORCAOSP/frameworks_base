...
public class DarkToggle extends StatefulToggle {
    ...
    protected void updateView() {
        ...
        setIcon(enabled ? R.drawable.ic_qs_bf_dark_on : R.drawable.ic_qs_bf_dark_off);
        setLabel(enabled ? R.string.quick_settings_bf_dark_on_label
                : R.string.quick_settings_bf_dark_off_label);
        super.updateView();
    }
